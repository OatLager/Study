...
input_id     = "//input[@id='id_email_2']"                      # 아이디 입력창 객체 추출
...
input_pwd    = "//input[@id='id_password_3']"                   # 패스워드 입력창 객체 추출
input_window = driver.find_element_by_xpath(input_pwd)          # 패스워드 입력창 객체 지정
input_window.send_keys(id_pwd)                                  # 패스워드 입력
time.sleep(1)
# - 사이트 로그인 / 로그인 버튼 클릭 
path_login   = "//button[@class='btn_g btn_confirm submit']"    # 로그인 버튼 객체 추출
